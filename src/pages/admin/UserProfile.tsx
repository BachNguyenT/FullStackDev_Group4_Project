...
import { faMagnifyingGlass, faChevronDown, faBan } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="p-4 sm:p-6 md:p-4">
            ...
            <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl sm:text-2xl font-semibold mb-4">User Profile</h2>
                <Button className="hover:bg-red-500 hover:text-white flex items-center" onClick ={() => setDeleteModalOpen(true)}>
